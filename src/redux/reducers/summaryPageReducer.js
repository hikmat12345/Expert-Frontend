const initialState = {
  ...
  nearestProviderInHouseRes:{},
  nearestProviderInClinicRes:{}
};
       ...
       case "SET_HOLD_PAYMENT_RESPONSE_TO_EMPTY":
        ...
        case "SALES_ORDER_ERROR":
          ...
          case "APPLY_DISCOUNT_CODE_ERROR":
            ...
            case "FIND_NEAREST_PROVIDER_INHOUSE_REQUEST":
              return { ...state, loading: true };
            case "FIND_NEAREST_PROVIDER_INHOUSE_RESPONSE":
              return {
                ...state,
                loading: false, 
                nearestProviderInHouseRes: payload,
              };
            case "FIND_NEAREST_PROVIDER_INHOUSE_ERROR":
              return { ...state, error: payload, loading: true,   };

              case "FIND_NEAREST_PROVIDER_REQUEST":
                return { ...state, loading: true };
              case "FIND_NEAREST_PROVIDER_RESPONSE":
                return {
                  ...state,
                  loading: false, 
                  nearestProviderInClinicRes: payload,
                };
              case "FIND_NEAREST_PROVIDER_ERROR":
                return { ...state, error: payload, loading: true,   };
