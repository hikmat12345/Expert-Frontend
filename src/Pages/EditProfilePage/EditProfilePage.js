...
import { Do_Empty_signup_reducer_OBJECT_Action } from "../../redux/actions/signUpPageActions";
...
const EditProfilePage = ({
  ...
  const profileUpdatedSuccessfully =async (customer) => { 
    if(!objectIsEmpty(customer)){
      //  if( !customer.isEmailVerified){
      //   // Do_Empty_signup_reducer_OBJECT_Action(); 
      //   console.log(customer, 'another updateProfileRespone') 
      //    history.push({pathname: "/account", state:{email:"aws lambda marketo etc"}})
      //  }
      //  else {
  ...
  //     console.log(updateProfileRespone, 'another updateProfileRespone') 
  //      history.push({pathname:"/account?signupstep=email-verification", state:{email:"newemail@yopmail.com"}})
  //    }
  //  }
  // }, [updateProfileRespone])
  return (
                        ...
                        {(fieldType === "text" ||
                          ...
                          !label.includes("Answer") && (
                            <FAETextField
                              ...
                              inputProps={{
                                readOnly: (fieldType === "email" && inputField !== "") && true,
                              }}
                            />
                          )}
                        {fieldType === "date" && (
