...
import { capturePaymentAction, createBooking, setCreateBookingResponseToEmpty, setHoldPaymentResponseToEmpty, setSaveBookingResponseToEmpty } from '../../redux/actions/summaryPageActions';
 ...
 const  ThreeDPage=({
   ...
   const [threeDsRespon, setThreedsRespons]=useState({})
    ...
    var transactionid = url?.searchParams?.get("transactionId") ?? 0; 
     const {isInClinic, bookingTime, bookingDate,  serviceName, isReferralReceiver,currencySymbol, selectedSessions, latitude,  longitude, UbookingId, totalAmount, returnUrl , Vouchercode, availableProviderId, paymentMethod, duration, serviceId, isTraining}=getCookies("summary_detail")
